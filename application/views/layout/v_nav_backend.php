   ...
   <div class="sidebar">
     ...
     <nav class="mt-2">
       <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <li class="nav-item">
           <a href="<?= base_url('knitstore') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'knitstore') {
                                                                  echo "active";
                                                                } ?>">
         ...
         <li class="nav-item">
           <a href="<?= base_url('gambarknitstore') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'gambarknitstore') {
                                                                        echo "active";
                                                                      } ?>">
